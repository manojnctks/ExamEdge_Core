...
namespace ExamEdge.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public IQueryable<UserProfileViewModel> ReadUserProfileList()
        {
            var userList = from t1 in db.UserProfiles.AsNoTracking()
                           ...
                           let t7=t1.RefId==null? null : db.Branches.Where(x=>x.BranchId==t1.RefId).SingleOrDefault()
                           select new UserProfileViewModel
                           {
                               ...
                               BranchName=t7==null?"":t7.BranchName
                           };
        ...
        public void SetupSelectLists(UserProfileViewModel model)
        {
            ...
            model.OrganizationSelectList = util.GetOrganizationList(model.OrganizationId);
